...
data.drop(['Numero Viagens', 'Ride Sharing Conceito', 'Idade:', 'Genero:'], axis=1, inplace=True)
# print(data.info)
########STEP 1########
...
# fa = FactorAnalyzer()
# fa.analyze(data, 19, rotation=None)
...
# Create factor analysis object and perform factor analysis
# fa = FactorAnalyzer()
# fa.analyze(data, 9, rotation="varimax")
# print(fa.loadings)
...
# numpy.savetxt("newDatasetWith9.csv",result,delimiter=";",fmt='%f')
# print(result)
